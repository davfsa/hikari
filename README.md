...
<a href="https://hikari-py.github.io/docs/latest"><img height="20" alt="Documentation status" src="https://img.shields.io/badge/documentation-up-00FF00.svg"></a>
</p>
</div>
...
[Other options also exist](https://hikari-py.github.io/docs/stable/impl/bot.html#hikari.impl.bot.GatewayBot) such as
[customising timeouts for requests](https://hikari-py.github.io/docs/stable/config.html#hikari.config.HTTPSettings.timeouts)
and [enabling a proxy](https://hikari-py.github.io/docs/stable/config.html#hikari.config.ProxySettings).
...
[Many other helpful options](https://hikari-py.github.io/docs/stable/impl/bot.html#hikari.impl.bot.GatewayBot.run)
